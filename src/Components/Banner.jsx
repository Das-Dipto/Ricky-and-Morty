      ...
      <div className="banner pt-10 pb-5">
        <div className="banner-content">
            ...
            <div className="heading-text">
              <div className="relative">
                <h1 className="banner-heading-text text-white flex text-3xl md:text-8xl font-bold">
                  <span className="italic me-3 relative">
                    THE{" "}
                    <img
                      className="absolute -top-7 right-7 md:-top-24 md:right-24"
                      src={bubble}
                      alt="bubble"
                    />{" "}
                  </span>
                  <img
                    className=" w-[50px] md:w-[15%] relative -top-3 md:-top-5"
                    src={portal}
                    alt="portal"
                  />
                  <span className="ms-3 medium-green">
                    RIC<span className="medium-blue me-5">K</span>
                    <span className="medium-blue relative">
                      &{" "}
                      <img
              ...
              <div className="relative">
                <h1 className="banner-heading-text text-white text-3xl md:text-8xl font-bold mt-5">
                  <span className="medium-green">MORTY</span>{" "}
                  <span className="italic">
                    WIKI
                    <img
                      className="absolute -right-2 md:-right-20 -top-2 md:-top-10 w-[30%]"
                      src={gun}
                      alt="gun"
                    />
                  </span>
          ...
          <div className=" mt-7 button-&-message flex flex-row flex-wrap-reverse justify-center">
            <button className="btn watch-now-button text-white font-semibold mt-7 md:mt-0 me-10">
              {" "}
              <RiPlayCircleLine style={{ fontSize: "20" }} /> Watch Now
            </button>
            <p className="medium-blue mt-8 w-[90%] mx-auto md:w-[25%] md:mx-0 message">
